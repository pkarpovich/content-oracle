...
import { ContentTriageModalProvider } from "../contexts/ContentTriageModalContext.tsx";
import { GlobalContentCardBottomSheet } from "../components/GlobalContentCardBottomSheet.tsx";
import { GlobalContentTriageModal } from "../components/GlobalContentTriageModal.tsx";
import styles from "./root.module.css";

const Root = () => {
    return (
        <ContentCardBottomSheetProvider>
            <ContentTriageModalProvider>
